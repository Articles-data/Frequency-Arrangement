...
def main():
    ...
    for gi, G in enumerate(graphs):
        ...
        line_collection = Line3DCollection(lines3d, zorder=gi-1, color=cols[gi], alpha=1, linewidth=2)
        ...
        # now add nodes
        ax.scatter(xs, ys, zs,color=cs, s=750,  marker='o', alpha=1, zorder=gi+1, linewidth=2, edgecolor='k')
    ...
    #plt.savefig("Figure1.pdf", transparent=True, backend='agg')
