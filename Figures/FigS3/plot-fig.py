...
def main():
    ...
    #R_U=Read_Data('./datas/r70_0to3.txt')
    ...
    plt.savefig("FigureS3_dpi100.jpg", dpi=100)

    plt.savefig("FigureS3_dpi300.png", dpi=300)
    plt.savefig("FigureS3_dpi300.jpg", dpi=300)
    from PIL import Image
    with Image.open('FigureS3_dpi300.png') as img:
        img.save('FigureS3-dpi300.tiff', format='TIFF', compression='tiff_lzw')
